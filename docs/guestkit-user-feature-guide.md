...
- **Python bindings** — [`zyvor-guestkit`](https://pypi.org/project/zyvor-guestkit/) on PyPI: Guestfs handle + assurance APIs (`run_doctor`, `run_migrate_repair`) for programmatic inspection and offline repair.
